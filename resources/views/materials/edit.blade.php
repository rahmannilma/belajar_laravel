...
<div class="max-w-3xl mx-auto">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="font-medium text-gray-900 dark:text-white">Edit Bahan</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/30">
            <h1 class="text-xl font-bold text-gray-900 dark:text-white">Edit Bahan: {{ $material->name }}</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi detail bahan baku atau peralatan</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="unit" id="unit" required
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-teal-500 focus:border-teal-500">
                        <option value="gr" {{ old('unit', $material->unit) == 'gr' ? 'selected' : '' }}>Gram (gr)</option>
                        <option value="ml" {{ old('unit', $material->unit) == 'ml' ? 'selected' : '' }}>Mililiter (ml)</option>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="purchase_price" id="purchase_price" value="{{ old('purchase_price', $material->purchase_price) }}" required min="0"
                ...
                <!-- Initial Stock -->
                <div>
                    <label for="stock" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Stok Saat Ini <span class="text-red-500">*</span></label>
                    <input type="number" step="0.01" name="stock" id="stock" value="{{ old('stock', $material->stock) }}" required min="0"
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-teal-500 focus:border-teal-500"
                        placeholder="0">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="min_stock" id="min_stock" value="{{ old('min_stock', $material->min_stock) }}" required min="0"
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-teal-500 focus:border-teal-500"
                        placeholder="0">
