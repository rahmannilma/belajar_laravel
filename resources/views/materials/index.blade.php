...
<div>
    ...
    <div class="block md:hidden space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div class="flex items-start justify-between mb-2">
                ...
                <div class="flex gap-1">
                    <a href="{{ route('materials.edit', $material) }}" class="p-1.5 text-gray-400 hover:text-blue-500 transition-colors" title="Edit">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                    </a>
                    <a href="{{ route('materials.branch-stock', $material) }}" class="p-1.5 text-gray-400 hover:text-purple-500 transition-colors" title="Stok Cabin">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-1 text-sm">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="text-gray-900 dark:text-white">Rp {{ number_format($material->purchase_price, 0, ',', '.') }}</span>
                </div>
                <div>
                    <span class="text-gray-500 dark:text-gray-400">Stok Cabin:</span>
                    @if($material->branchStocks->count() > 0)
                    <div class="mt-1 space-y-1">
                        @foreach($material->branchStocks as $bs)
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-700 dark:text-gray-300 truncate">{{ $bs->branch->name }}:</span>
                            <span class="px-2 py-0.5 text-xs font-medium rounded-full ml-2 {{ $bs->stock > $material->min_stock ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : ($bs->stock > 0 ? 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400') }}">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400">Tidak ada bahan ditemukan</p>
        </div>
        @endforelse
    </div>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('materials.edit', $material) }}" class="p-2 text-gray-400 hover:text-blue-500 transition-colors" title="Edit">
